  ...
  return (
    <div className={`max-w-4xl mx-auto ${className || ""}`}>
      <div className="text-center">
        ...
        <div>
          <h1 className="font-inter-tight text-4xl sm:text-5xl md:text-6xl font-bold text-gray-800 dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-b dark:from-indigo-200 dark:to-gray-200 pb-4">
            {title}
          </h1>
